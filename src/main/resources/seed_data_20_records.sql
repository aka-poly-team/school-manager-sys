-- =================================================================================
-- AKA SYSTEM — SCRIPT BỔ SUNG DATA MẪU (20 BẢN GHI CHO MỖI BẢNG)
-- Môi trường: SQL Server 2016+ / Azure SQL / LocalDB
-- Lưu ý: NGUYÊN TẮC TUYỆT ĐỐI KHÔNG DROP / XÓA BẢNG USERS CỦA NGƯỜI DÙNG.
-- =================================================================================

USE aka;
GO

-- 1. BẢNG TRƯỜNG MẦM NON (20 BẢN GHI)
IF OBJECT_ID('dbo.Schools', 'U') IS NOT NULL
BEGIN
    -- Thêm dữ liệu mẫu nếu chưa có đủ
...
-- 2. BẢNG LỚP HỌC AEROBIC (20 BẢN GHI)
...
-- 3. BẢNG LỊCH GIẢNG DẠY TUẦN (20 BẢN GHI)
...
-- 4. BẢNG NHẬT KÝ ĐIỂM DANH & CHẤM CÔNG (20 BẢN GHI)
...
-- 5. BẢNG YÊU CẦU XIN NGHỈ & DẠY THAY (20 BẢN GHI)
...
-- 6. BẢNG KHIẾU NẠI CHẤM CÔNG (20 BẢN GHI)
...
-- 7. BẢNG THÔNG BÁO HỆ THỐNG (20 BẢN GHI)
...
-- 8. BẢNG NHẬT KÝ HỆ THỐNG (20 BẢN GHI)
...
-- 9. BẢNG BIỂU MẪU CHỨNG TỪ (20 BẢN GHI)
IF OBJECT_ID('dbo.DocumentTemplates', 'U') IS NOT NULL
BEGIN
